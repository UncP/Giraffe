...
std::vector<Object *> obj = {
	...
	new Sphere(Point3d(-55, -45, -210), 15, sphere1),
	new Sphere(Point3d(-40, -45, -195), 15, sphere1),
	new Sphere(Point3d(-25, -45, -180), 15, sphere1),
	new Sphere(Point3d(-10, -45, -165), 15, sphere1),
	new Sphere(Point3d(5, -45, -150), 15, sphere1),
	new Sphere(Point3d(20, -45, -135), 15, sphere1),
	new Sphere(Point3d(35, -45, -120), 15, sphere1),
	new Sphere(Point3d(50, -45, -105), 15, sphere1)
